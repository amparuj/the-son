...
<?php $__env->startSection('content'); ?>
  <div class="container py-3">
    ...
    <form method="POST" action="<?php echo e(route('qr.submit', $table->public_uuid)); ?>" id="qrForm">
      <?php echo csrf_field(); ?>
      ...
      <div class="row g-3" id="menuList">
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-6 col-md-4 col-lg-3 menu-item"
               data-name="<?php echo e(mb_strtolower($product->name ?? '')); ?>">
            ...
            <div class="menu-card">
              ...
              <div class="menu-body">
                <div class="menu-name"><?php echo e($product->name); ?></div>
                <div class="menu-price"><?php echo e(number_format($product->price)); ?> บาท</div>

                
                <div class="selected-items" data-product-id="<?php echo e($product->id); ?>"></div>
                ...
                <div class="mt-2 small text-muted">
                  จำนวนที่เลือก: <span class="qty-badge" data-product-id="<?php echo e($product->id); ?>">0</span>
                </div>
              </div>
...
<?php echo $__env->make('layouts.qr', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/paruj.le/Documents/restaurant_pos_phase1_laravel11_breeze/resources/views/qr/menu.blade.php ENDPATH**/ ?>